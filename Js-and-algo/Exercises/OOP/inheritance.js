...
class Principal extends Person {
    ...
    hireTeacher(teacher) {
        ...
        console.log(`${this.name} just hired ${teacher}`)
    }
...
//1 & 2
p1.hireTeacher(t1.name) //should print "Martin just hired Cassandra"
console.log(p1.teachers) //should print Array(1) [Teacher] - the teacher should be Cassandra

p1.hireTeacher(t2.name) //should print "Martin just hired Kevin"
